...
export function newPlan() {
  return { id: newId(), title: "", prefectureId: "", startDate: "", endDate: "", departureLocation: "", departureTime: "", returnLocation: "", returnTime: "", people: "1", companions: "", budget: "", places: "", foods: "", activities: "", accommodation: "", transport: "", notes: "", status: "planning", days: [], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() };
}
...
export function loadPlans() {
  try {
    ...
    const plans = data.plans.map(plan => ({
      ...
      departureTime: typeof plan.departureTime === "string" ? plan.departureTime : "",
      returnLocation: typeof plan.returnLocation === "string" ? plan.returnLocation : "",
      returnTime: typeof plan.returnTime === "string" ? plan.returnTime : "",
