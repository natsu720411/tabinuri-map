...
export const PLAN_FIELDS = ["title", "startDate", "endDate", "departureLocation", "returnLocation", "people", "companions", "budget", "places", "foods", "activities", "accommodation", "transport", "notes"];
